<?php
   ...
   if(isset($_REQUEST['newStuSubmitBtn'])){
       ...
       if(($_REQUEST['stu_name'] == "")  || ($_REQUEST['stu_email'] == "") ||  ($_REQUEST['stu_pass'] == "") || ($_REQUEST['stu_occ'] == "")){
            ...
            $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-3">Fil All Fields</div>';
             ...
             $sql = "INSERT INTO  student (stu_name,stu_email,stu_pass, stu_occ) VALUES ('$stu_name','$stu_email',
             '$stu_pass','$stu_occ')";

             if($conn->query($sql) == TRUE){
               $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-3">Student Added Succesfully</div>';  
             }else{
               $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-3">Unable to add Student</div>';
             }
