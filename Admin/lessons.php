...
<?php
  ...
  while($row = $result->fetch_assoc()){
      ...
      if(($row['course_id']) == $_REQUEST['checkid']){
        ...
        Course ID: <?php if(isset($row['course_id'])) {echo $row['course_id']; }?> Course Name: <?php if(isset($row['course_name'])) {echo $row['course_name']; }?>
        </h3>
...
echo '<table class="table">
        ...
        echo '<div class="alert alert-dark">Course Not Found</div>';
      }
